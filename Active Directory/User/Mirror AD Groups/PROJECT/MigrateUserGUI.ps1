function Start-Logging(){
    ...
    Import-Module -DisableNameChecking -name "V:\HelpDesk\Powershell Automation\ServiceDesk\NewHireMigration\ServiceDeskNewHire\Modules\Red_Table.psm1"
    ...
    [System.Collections.ArrayList]$RedArray = @()       
...
Function Open-GUI{
    ...
    #User Tools Sub
    $Proton_User_Tools_NewHire = New-Object System.Windows.Forms.ToolStripMenuItem
    #Client Tools Sub
    ...
    $Proton_User_Tools.DropDownItems.AddRange(@($Proton_User_Tools_NewHire)) | Out-Null

    #User Tools sub Option
    $Proton_User_Tools_NewHire.Size= '35,20'
    $Proton_User_Tools_NewHire.Name= 'NewHire'
    $Proton_User_Tools_NewHire.Text= "Migrate New Hire"
    $Proton_User_Tools_NewHire.Add_Click({
         Add-Type -AssemblyName System.Windows.Forms
                                    [System.Windows.Forms.Application]::EnableVisualStyles()
 
                                    $NewHire_Form = New-Object system.Windows.Forms.Form
                                    $NewHire_Form.ClientSize= '915,575'
                                    $NewHire_Form.text= "Form"
                                    $NewHire_Form.TopMost= $false
                                    $NewHire_Form.BackgroundImage = $Image
                                    $NewHire_Form.FormBorderStyle= "FixedDialog"                          
                                    $NewHire_Form.text = "New Hire Migration"
                                
                                    $Script:Mirror_TextBox= New-Object system.Windows.Forms.TextBox
                                    $Script:Mirror_TextBox.multiline= $false
                                    $Script:Mirror_TextBox.width= 146
                                    $Script:Mirror_TextBox.height= 20
                                    $Script:Mirror_TextBox.location= New-Object System.Drawing.Point(762,20)
                                    $Script:Mirror_TextBox.Font= 'Microsoft Sans Serif,10'                                   

                                    $Script:NewHire_TextBox= New-Object system.Windows.Forms.TextBox
                                    $Script:NewHire_TextBox.multiline= $false
                                    $Script:NewHire_TextBox.width= 146
                                    $Script:NewHire_TextBox.height= 20
                                    $Script:NewHire_TextBox.location= New-Object System.Drawing.Point(762,50)
                                    $Script:NewHire_TextBox.Font= 'Microsoft Sans Serif,10'                                   

                                    $NewHire_Value_Red= New-Object system.Windows.Forms.DataGridView
                                    $NewHire_Value_Red.width  = 300
                                    $NewHire_Value_Red.height  = 500
                                    $NewHire_Value_Red.ReadOnly= $true
                                    $NewHire_Value_Red.MultiSelect= $false
                                    $NewHire_Value_Red.AllowUserToAddRows=$false
                                    $NewHire_Value_Red.location  = New-Object System.Drawing.Point(2,75)

                                    $NewHire_Value_Yellow= New-Object system.Windows.Forms.DataGridView
                                    $NewHire_Value_Yellow.width  = 300
                                    $NewHire_Value_Yellow.height  = 500
                                    $NewHire_Value_Yellow.ReadOnly= $true
                                    $NewHire_Value_Yellow.MultiSelect= $false
                                    $NewHire_Value_Yellow.AllowUserToAddRows=$false
                                    $NewHire_Value_Yellow.location  = New-Object System.Drawing.Point(305,75)

                                    $NewHire_Value_White= New-Object system.Windows.Forms.DataGridView
                                    $NewHire_Value_White.width  = 300
                                    $NewHire_Value_White.height  = 500
                                    $NewHire_Value_White.ReadOnly= $true
                                    $NewHire_Value_White.MultiSelect= $false
                                    $NewHire_Value_White.AllowUserToAddRows=$false
                                    $NewHire_Value_White.location  = New-Object System.Drawing.Point(608,75)

                                    $NewHire_Import_Button= New-Object system.Windows.Forms.Button
                                    $NewHire_Import_Button.text= "Import"
                                    $NewHire_Import_Button.width= 75
                                    $NewHire_Import_Button.height= 20
                                    $NewHire_Import_Button.location= New-Object System.Drawing.Point(675,20)
                                    $NewHire_Import_Button.Font= 'Calibri,10'
                                    $NewHire_Import_Button.Add_Click({
                                    $Red_Rable_Hold = updateRedData -Client_Lookup_Value  $Script:Mirror_TextBox.text
                                    $Red_users_Lookup_GridDataTable.datasource = $Red_Rable_Hold.Tables[0]
                                    $Red_users_Lookup_GridDataTable.Update()
                                    
                                    })
                                    
                                    $NewHire_Migrate_Button= New-Object system.Windows.Forms.Button
                                    $NewHire_Migrate_Button.text= "Migrate"
                                    $NewHire_Migrate_Button.width= 75
                                    $NewHire_Migrate_Button.height= 20
                                    $NewHire_Migrate_Button.location= New-Object System.Drawing.Point(675,45)
                                    $NewHire_Migrate_Button.Font= 'Calibri,10'
                                    $NewHire_Migrate_Button.Add_Click({})
                                                                                
                                                    #Label above the NewHire users gridview.
                                    $NewHire_Label= New-Object system.Windows.Forms.Label
                                    $NewHire_Label.text= "Groups that cannot be added"
                                    $NewHire_Label.AutoSize  = $true
                                    $NewHire_Label.width= 25
                                    $NewHire_Label.height= 10
                                    $NewHire_Label.location= New-Object System.Drawing.Point(6,18)
                                    $NewHire_Label.forecolor= "White"               
                                    $NewHire_Label.backcolor= [System.Drawing.Color]::FromName("Transparent")
                                    $NewHire_Label.Font= $NewHire_Label.Font= 'Microsoft Sans Serif,10,style=Bold'

                                    $NewHire_Form.controls.AddRange(@(
                                    $Script:Mirror_TextBox,
                                    $Script:NewHire_TextBox,
                                    $NewHire_Value_Red,
                                    $NewHire_Value_Yellow,
                                    $NewHire_Value_White,
                                    $NewHire_Import_Button,
                                    $NewHire_Migrate_Button,
                                    $NewHire_Label
                                    ))
                                    Start-Logging "INFO: $(Get-Date -UFormat "%Y-%m-%d %r") - updateData: `"Exporting Data - $Script:Lookup_TextBox`""
                                                                                  
                                    # NewHire GridviewMain Columns
                                    $NewHire_GridDataTable_Red= New-Object System.Data.DataTable

                                    #Column A
                                    $NewHire_GridDataTable_Red.Columns.Add('Name', [string]) | Out-Null   
                                                                     
                                    # NewHire GridviewMain Columns
                                    $NewHire_GridDataTable_Yellow= New-Object System.Data.DataTable

                                    #Column A
                                    $NewHire_GridDataTable_Yellow.Columns.Add('Name', [string]) | Out-Null  

                                    $NewHire_GridDataTable_White= New-Object System.Data.DataTable
                                    #Column A
                                    $NewHire_GridDataTable_White.Columns.Add('Name', [string]) | Out-Null  

                                    #Passes the table as a dataset. Returns the data set. This is what processes the datagridview.
                                    $NewHire_ds= New-Object System.Data.DataSet
                                    #$NewHire_ds.Tables.Add($NewHire_GridDataTable_Red,$NewHire_GridDataTable_Yellow, $NewHire_GridDataTable_White)
                                    Start-Logging "INFO: $(Get-Date -UFormat "%Y-%m-%d %r") - updateData: `"Stop - $Script:Lookup_TextBox`""
                                                                                                  
                                    #$NewHire_Value.DataSource= $NewHire_ds.Tables[0]
 
                                    $NewHire_Form.ShowDialog() 
